...
public class ResourceTest extends EllipseUnitDriver
{
	...
	public void testAction()
	{
		try
		{
    		...
    		inputFile = "./test-data/SyncResource.xml";
            ...
            com.transgrid.mib.ellipse.hr.action.ResourceAction action = new com.transgrid.mib.ellipse.hr.action.ResourceAction( config );
	...
	protected Map invokeInputMapping()
	{
		...
		String inputFile = "./test-data/SyncResource.xml";
